    ...
    <div className='flex flex-col'>
      ...
      <div className='w-full pt-24 text-black'>
        <section className='max-w-[1290px] px-10 border-0 border-solid border-gray-300' style={{textAlign:'center',marginLeft:'auto',marginRight:'auto',fontSize:'1.125rem',lineHeight:'1.75rem',fontWeight:'400',color:'black'}}>
          <div className='max-w-[980px] md:mx-[115px]'>
            <div className={`${isScrolledToSection.section1 ? 'top-0': 'top-24'} transition-all duration-500  relative`}>
      ...
      <div className='w-full py-24 text-[#00000] bg-[#F0EDE8]'>
        <section className='max-w-[1290px] text-base ml-auto mr-auto px-10 '>
          <div className={`max-w-[980px] text-lg ml-auto text-right relative ${isScrolledToSection.section2 ?'top-0': 'top-24'} transition-all duration-500`}>
        ...
        <section className='w-full block mt-[96px]'>
          <div className='w-full md:flex items-start justify-between gap-10 relative'>
            ...
            <div className='flex gap-10'>
              <LinkCart
                className={`${isScrolledToSection.section3 ? 'top-0': 'top-[60px]'} transition-all duration-[250ms] relative`}
                img={Building}
                name={'The Building'}
                link="/building"
              />
              <LinkCart
                className={`${isScrolledToSection.section3 ? 'top-0': 'top-[120px]'} transition-all duration-[500ms] relative`}
                img={Roof} 
                name={'The Roof'}
                link="/roof"
              />
            ...
            <div className='flex gap-10'>
              <LinkCart 
                className={`${isScrolledToSection.section3 ? 'top-0': 'top-[180px]'} transition-all duration-[750ms] relative`}
                img={Neighborhood}
                name={'The Neightborhood'}
                link="/neighborhood"
              />
              <LinkCart 
                className={`${isScrolledToSection.section3 ? 'top-0': 'top-[240px]'} transition-all duration-[1000ms] relative`}
                img={Gallery}
                name={'Gallery'}
                link="/gallery"
              />
      ...
      <div className="w-full text-[#00000] text-base py-24 ">
        <section className="md:flex w-full">
          <div className="w-full justify-center opacity-100 transform-none ease-linear duration-40 pointer-events-auto">
            <div ref={section4Ref} id="section4"></div>
          ...
          <div className="w-full px-10 flex">
            <div className=" max-w-[557px]  opacity-100 transform-none transition-opacity ease-linear duration-40 pointer-events-auto text-lg font-normal block my-auto">
              <div ref={section5Ref} id="section5"></div>
